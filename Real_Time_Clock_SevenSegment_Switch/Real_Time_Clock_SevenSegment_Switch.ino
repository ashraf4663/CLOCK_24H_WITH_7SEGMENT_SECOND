/*
 * 08 06 2023 24H CLOCK SHIMULATOR
*/
#include <DS3231.h>//Memanggil RTC3231 Library
#include <Wire.h>  // i2C Conection Library if not find pleace change ic tinny to Uno
...
int hh = 0, hh1=0, hh2=0, mm = 0, mm1 = 0, mm2 = 0, ss = 0, ss1 = 0, ss2 = 0, dd = 0, bb = 0, set_day;
int yy = 0;
String Day = "  ";
...
int dec_digits [11] {252, 96, 218, 242, 102, 182, 190, 224, 254, 246, 0}; // 4095 for Digi Elec Connection
...
yy = t.year,DEC;
  ...
  if(setAlarm==0){
   ...
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[ss%10]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[(ss/10)%10]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[mm%10]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[(mm/10)%10]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[hh%10]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[(hh/10)%10]);
...
{  digitalWrite(STCP_Pin,LOW);
   ...
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[(mm%10)]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[(mm/10)%10]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[11]);
   shiftOut(DS_Pin, SHCP_Pin, LSBFIRST, dec_digits[11]);
   digitalWrite(STCP_Pin,HIGH);
}
